...
devuelve un booleano.*/
    ...
    /*el método crear persona, le pide los valores de los
atributos al usuario y después se le asignan a sus respectivos atributos para
llenar el objeto Persona. Además, comprueba que el sexo introducido sea correcto,
es decir, H, M o O. Si no es correcto se deberá mostrar un mensaje*/
    public void crearPersona() {
        ...
        do {
            ...
            if ((p1.getSexo() != 'H') && (p1.getSexo() != 'M') && (p1.getSexo() != 'O')) {
                System.out.println("Ingreso una opcion invalida, ingrese de nuevo");
            }
...
sobrepeso, y la función devuelve un 1.*/
    public int calcularIMC() {
        ...
        if ((p1.getPeso() / Math.pow(p1.getAltura(), 2) < 20)) {
            return -1;
        } else if (p1.getPeso() / Math.pow(p1.getAltura(), 2) < 26) {
            return 0;
        } else {
            return 1;
        }
